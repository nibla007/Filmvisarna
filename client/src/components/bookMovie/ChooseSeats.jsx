...
export default function ChooseSeats({ screening, seats, setSeats }) {
  ...
  const Seat = ({ seatNumber, rowNumber, booked }) => (
    <button data-testid="seats" className={`${booked ? "bg-red-600" : "bg-footerGrey cursor-pointer"} seat lg:w-10 lg:h-7 md:w-8 md:h-8 w-5 h-5 `}
  ...
  return (
    <div data-testid="choose-seats"  className="lg:w-[700px] md:w-[70%] w-[80%] container mt-5">
