    ...
    return (
        <div className="text-white flex flex-col w-4/5 items-center m-auto">
            <div className="flex flex-col">
                <h4 className="text-2xl" data-testid="text-2xl">Är du medlem? (valfritt)</h4>
            ...
            <div className="flex flex-col">
                ...
                <input onChange={handleChange} data-testid="email" name="email" value={inputValues.email} className="py-2 px-4 rounded w-[16em] text-black" type="text" />
                <label className="font-inconsolata mt-4" htmlFor="re-email">Bekräfta mailadress</label>
                <input onChange={handleChange} data-testid="email-again" name="reEmail" value={inputValues.reEmail} className="py-2 px-4 rounded text-black" type="text" />
                <label className="font-inconsolata mt-4" htmlFor="email">Mobiltelefon</label>
                <input onChange={handleChange} data-testid="phone" name="phone" value={inputValues.phone} className="py-2 px-4 rounded mb-10 text-black" type="text" />
            </div>
        </div>
    )
}
